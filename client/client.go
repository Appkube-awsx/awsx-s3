...
import (
	...
	"github.com/Appkube-awsx/awsx-s3/awssession"
...
func GetClient(region string, crossAccountRoleArn string, accessKey string,  secretKey string, externalId string) *s3.S3{
...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string) *s3.S3 {
	...
	clusterClient := s3.New(awsSession)
